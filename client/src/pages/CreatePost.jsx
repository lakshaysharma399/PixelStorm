    ...
    <section className='max-w-7x1 mx-auto'>
      ...
      <form className='mt-16 max-w-3x1' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          />
          <div className='relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-1g
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>Once you have the image you want , you can share it with others in the community</p>
